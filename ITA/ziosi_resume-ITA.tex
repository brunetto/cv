...
%  brunettomarco.ziosi@studenti.unipd.it
...
\ecvsection{Informazioni personali}
\ecvitem{Cognome/Nome}{\bf \large Ziosi Brunetto Marco}
\ecvitem{Indirizzo}{via Ivancich n. 17, 30174, Chirignago (VE)}
\ecvitem{Telefono}{(+39) 347 4958152}
\ecvitem{E-mail}{brunetto.ziosi@gmail.com}
\ecvitem{Nazionalit\`a}{Italiana}
\ecvitem{Data di nascita}{03/05/1985}
\ecvitem{Website}{\texttt{brunettoziosi.eu}}
\ecvitem{LinkedIn}{\texttt{https://www.linkedin.com/in/brunettoziosi}}
\ecvitem{Rrepository pubblico}{\texttt{https://github.com/brunetto}}

\ecvitem{Posizione attuale}{Studente di dottorato da Gennaio 2012 presso Universit\`a di Padova -
Department of Physics and Astronomy

 \textbf{Borsa di dottorato finanziata da:} "Strategic Research Project AACSE - Algorithms and Architectures for Computational Science and Engineering"
 
 PhD Thesis submission expected in July 2015}
 
\ecvsection{Educazione \& Lavoro}
\ecvitem{2015/01-2015/07}{Borsa INAF-OAPd per lavorare sul progetto: ``Study of gravitational 
waves sources in young star clusters by means of direct N-body simulations.''}
\ecvitem{2012-2015}{Scuola di dottorato in Astronomia  - Dipartimento di Fisica e Astronomia, Universit\`a di Padova}
...
\ecvitem{2007-2011}{Laurea specialistica in Astronomia  - Dipartimento di Fisica e Astronomia, Universit\`a di Padova}
% , (108/110): `\emph{`Halo-matter
% cross-correlation in
% cosmological simulation''}, supervisors: Prof. Giuseppe Tormen and Prof. Ravi K. Sheth\\}


\ecvitem{2004-2007}{Laurea triennale in Astronomia  - Dipartimento di Fisica e Astronomia, Universit\`a di Padova}

% (103/110): \emph{``Studio del
% profilo dei
...
\ecvsection{Esperienze di insegnamento}
\ecvitem{2012-2013}{
\begin{itemize}
\item Teaching assistant - Department of Physics and Astronomy, University of Padova, Mathematical Analysys
\item Teaching assistant - Department of Physics and Astronomy, University of Padova, Python course
\end{itemize}}
...
\ecvsection{Altri corsi ed esperienze}
...
\ecvitem{2004}{European Computer Driving Licence (ECDL)}
...
\ecvsection{Cacpacit\`a linguistiche}
...
\ecvitem{}{Italiano (madrelingua), Inglese}

\ecvsection{Capacit\`a informatiche}
\ecvitem{OSs}{Linux, MacOS, Windows}
\ecvitem{Linguaggi di programmazione/scripting}{Python, Go, Bash, 
C/C++, Matlab/Octave, Fortran}
\ecvitem{Analisi dati/visualizzazione}{Veusz, Matplotlib/Pylab} 
...
% 		\end{itemize}		
% \end{description}}
\ecvitem{Linguaggi di Markup/Web}{LaTeX, Markdown, HTML, Javascript}
\ecvitem{Grafica}{Inkscape, Gimp, ImageMagick, Blender}
\ecvitem{Presentazioni}{Beamer, Sozi/Inkscape, Prezi, PowerPoint, Javascript (Remark)}
\ecvitem{Office/Internet}{MSOffice, LibreOffice/OpenOffice, Chrome, Internet Explorer, Firefox, Opera, Outlook, Thuderbird}
\ecvitem{Web}{Hugo, Nikola, Pelica, Wordpress, Blogger, basi di HTML5/CSS3 e Javascript}
\ecvitem{Altro}{Git, MongoDB, MySQL, PostgreSQL}

\ecvsection{Altri interessi}
\ecvitem{}{

Volunteering with A.G.E.S.C.I. (Brevetto Wood Badge 17/03/2012-356) and Protezione Civile

Fotografia digitale

Viaggiare

Mapping e manipolazione di dati geografici (OpenStreetMap project)
}
