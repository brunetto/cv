...
\ecvitem{Public repository}{\texttt{https://github.com/brunetto}}

\ecvitem{Current Position}{Full stack ERP developer at Pixartprinting - a Cimpress company}
...
\ecvitem{2012-2015}{PhD School in Astronomy - Dipartimento di Fisica e
Astronomia
  (Università degli Studi di Padova), Research project title: \emph{``The impact of stellar evolution and dynamics on the formation of compact-object binaries''}, supervisors: Dr. Michela Mapelli 
...
\ecvitem{Scripting/Programming Languages}{Python, Go, Bash, 
...
\ecvitem{Others}{Git, MongoDB, MySQL, PostgreSQL}
