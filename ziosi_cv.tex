...
C/C++ (excellent), Matlab/Octave (excellent), Fortran (base), IDL (base)}
...
\item {\it HCP facilities I have used during my PhD:} Eurora (CINECA), Green II/gStar (Swinburne University), PLX (CINECA), 
...
\ecvitem{}{dynamics of black holes and neutron stars in star clusters -- 
