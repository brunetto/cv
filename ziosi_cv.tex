...
\item``Making very massive stars through stellar collisions'', 50.0k on GPU cluster EURORA and IBM PLX cluster @ CINECA, PI: Mapelli, CO-I: Ziosi and 2 other COIs
\end{itemize}}
\ecvitem{2012}{
\begin{itemize}
...
\ecvitem{Experience in HPC}{\textcolor{red}{Compile, run and modify of StarLab on Eurora (CINECA), PLX (CINECA), 
ZBOX (University of Zurich), Green II/gStar (Swinburne University), and various workstations, 
developed managing and analysis tools}}
