...
\ecvitem{2007}{Certificate digital data analysis expert (FSE european course)}
...
\item Branchesi M. et al., {\it C7 multi-messenger astronomy of GW sources}, 2014, General Relativity and Gravitation, 46, 1771
\end{itemize}
}
...
\ecvitem{OSs}{Linux (excellent), MacOS (advanced), Windows (advanced)}
\ecvitem{Scripting/Programming Languages}{Python (advanced), Go (advanced), Bash (good), 
...
\item {\it Machines:} Eurora (CINECA), Green II/gStar (Swinburne University), PLX (CINECA), 
ZBOX (University of Zurich), monster (Dept. of Physics and Astronomy, UniPD), 
SP7 (Dept. of Information Engineering, UniPD)
\end{description}}
\ecvitem{Markup Languages/Web}{LaTeX (expert), Markdown, HTML (base), Javascript (base)}
